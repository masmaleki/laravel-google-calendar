...
namespace Masmaleki\GoogleCalendar\Tests\Integration;

use Carbon\Carbon;
use DateTime;
use Mockery as m;
use Masmaleki\GoogleCalendar\Event;
use Masmaleki\GoogleCalendar\Tests\TestCase;

class EventTest extends TestCase
{
    /** @var \Masmaleki\GoogleCalendar\Event */
    protected $event;
